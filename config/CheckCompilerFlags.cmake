...
IF(NOT (CMAKE_CXX_COMPILER_ID MATCHES "GNU" AND
  ...
  ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-pedantic")
ENDIF()

# Check for compiler types and add flags accordingly
if ( CMAKE_COMPILER_IS_GNUCXX OR (CMAKE_CXX_COMPILER_ID MATCHES "Clang") )

  ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-fpic")
  ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-Wall")
  ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-pipe")
  ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-Wno-long-long")
  ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-Wextra")
  ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-Wno-cast-align")
  ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-Wsign-compare")
  ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-Wpointer-arith")
  ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-Wformat")
  ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-Wformat-security")
  ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-Wno-unused-parameter")
  ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-fstack-protector-all")
  ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-mtune=native")
  ...
  # ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-Wno-c++11-long-long")
  if (CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 4.8)
    ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-Wno-unused-local-typedefs")
  endif()
  ...
  IF(CMAKE_CXX_COMPILER_ID MATCHES "Intel")
    ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-ansi")  # standard compliant
    ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-w2")    # verbose warnings
    ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-Wall")
    # disable some warnings -- consistent with autoconf
    # -wd981 -wd279 -wd1418 -wd383 -wd1572 -wd2259
    ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-wd981")
    ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-wd279")
    ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-wd1418")
    ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-wd383")
    ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-wd1572")
    ENABLE_IF_SUPPORTED(MESHKIT_CXX_FLAGS "-wd2259")
    FORCE_ADD_FLAGS(CMAKE_C_FLAGS "${MESHKIT_CXX_FLAGS}")
    FORCE_ADD_FLAGS(CMAKE_Fortran_FLAGS "${MESHKIT_CXX_FLAGS}")
    # ifort (untested)
...
FORCE_ADD_FLAGS(CMAKE_CXX_FLAGS "${MESHKIT_CXX_FLAGS}")
...
mark_as_advanced(CMAKE_Fortran_FLAGS MESHKIT_CXX_FLAGS)
