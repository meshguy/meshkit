...
OneToOneSwept::OneToOneSwept(iGeom_Instance &geometry, iMesh_Instance &Mesh, iRel_Instance &association, iRel_RelationHandle &irel)
{
	geom = geometry;
	mesh = Mesh;
	assoc = association;
...
void OneToOneSwept::buildAssociation(iGeom_Instance &geom, iMesh_Instance &mesh, iRel_Instance &assoc, iRel_RelationHandle &rel)
{
