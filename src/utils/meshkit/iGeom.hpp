...
public:
  ...
  virtual inline Error getArrType(const EntityHandle* entity_handles,
      int entity_handles_Size, EntityType* types_out);

  virtual inline Error getEntAdj(EntityHandle handle,
      EntityType type_requested, std::vector<EntityHandle>& adj_entities_out);
  ...
  virtual inline Error getArr2ndAdj(const EntityHandle* entity_handles,
      ...
      std::vector<EntityHandle>& adjacent_entity_handles_out, int* offsets_out);
  ...
  virtual inline Error isArrAdj(const EntityHandle* entities1,
      const EntityHandle* entities2, int num_entity_pairs, int* is_adj_out);
  ...
  virtual inline Error getArrNrmlPlXYZ(const EntityHandle* entities,
      ...
      int near_xyz_size, double* on_xyz, double* nrml_ijk);
  ...
  virtual inline Error getVtxArrCoords(const EntityHandle* vertices,
      int vertices_size, StorageOrder order, double* coords);
  ...
  virtual inline Error getPntArrClsf(StorageOrder order, const double* coords,
      int coords_size, EntityHandle* entities_out);
  ...
  virtual inline Error getArrNrmlSense(const EntityHandle* faces,
      int faces_size, const EntityHandle* vols, int vols_size, int* senses_out);
  ...
  virtual inline Error getEgVtxArrSense(const EntityHandle* edges,
      ...
      const EntityHandle* vertices2, int vertices2_size, int* senses_out);
  ...
  virtual inline Error getArrSense(const EntityHandle *ent, int num_ents,
      EntityHandle wrt_ent, int *sense);
  ...
  virtual inline Error isArrParametric(const EntityHandle* entities,
      int entities_size, int* is_parametric);
  ...
  virtual inline Error getArrUVtoXYZ(const EntityHandle* faces, int faces_size,
      StorageOrder order, const double* uv, int uv_size, double* xyz);
  virtual inline Error getArrUtoXYZ(const EntityHandle* edges, int edges_size,
      const double* u, int u_size, StorageOrder order, double* xyz);
  ...
  virtual inline Error getArrXYZtoUV(const EntityHandle* faces, int faces_size,
      StorageOrder order, const double* coords, int coords_size, double* uv);
  virtual inline Error getArrXYZtoU(const EntityHandle* edges, int edges_size,
      StorageOrder order, const double* coords, int coords_size, double* u);
  ...
  virtual inline Error getArrNrmlUV(const EntityHandle* faces, int faces_size,
      StorageOrder order, const double* uv, int uv_size, double* normals);
  ...
  virtual inline Error getArrTgntU(const EntityHandle* edges, int edges_size,
      StorageOrder order, const double* u, int u_size, double* normals);
  ...
  virtual inline Error
      getEnt2ndDrvt(EntityHandle handle, double u, double v, double& duu_i,
          ...
          double& dvv_k, double& duv_i, double& duv_j, double& duv_k);
  virtual inline Error getArr1stDrvt(const EntityHandle* entities,
      ...
      double* dvtr_u, double* dvtr_v);
  virtual inline Error getArr2ndDrvt(const EntityHandle* entities,
      int entities_size, StorageOrder order, const double* uv, int uv_size,
      double* dvtr_uu, double* dvtr_vv, double* dvtr_uv);

  virtual inline Error getFcCvtrUV(EntityHandle face, double u, double v,
      double& i1, double& j1, double& k1, double& i2, double& j2, double& k2);
  ...
  virtual inline Error getArrTolerance(const EntityHandle* entities,
      int entities_size, double* tolerances);

  virtual inline Error getEntUVRange(EntityHandle face, double& u_min,
      double& v_min, double& u_max, double& v_max);
  ...
  virtual inline Error getArrUVRange(const EntityHandle* faces, int faces_size,
      StorageOrder order, double* uv_min, double* uv_max);
  ...
  virtual inline Error getEntUtoUV(EntityHandle edge, EntityHandle face,
      double edge_u, double& face_u, double& face_v);
  ...
  virtual inline Error getErrorType();

  virtual inline EntitySetHandle getRootSet();
  ...
  virtual inline Error getEntSets(EntitySetHandle set, int num_hops, std::vector<
      EntitySetHandle>& contained_sets_out);
  ...
  virtual inline Error isEntSetContained(EntitySetHandle containing_set,
      EntitySetHandle contained_set, bool& contained_out);
  ...
  virtual inline Error getTagName(TagHandle tag_handle, std::string& name_out);
  virtual inline Error getTagSizeValues(TagHandle tag_handle, int& size_out);
  virtual inline Error getTagSizeBytes(TagHandle tag_handle, int& size_out);
  virtual inline Error getTagHandle(const char* name, TagHandle& handle_out);
  virtual inline Error getTagType(TagHandle tag_handle, TagValueType& type_out);
  ...
  virtual inline Error getEntSetIntData(EntitySetHandle set_handle,
      TagHandle tag_handle, int& value_out);
  ...
  virtual inline Error getArrData(const EntityHandle* entity_handles,
      int entity_handles_size, TagHandle tag_handle, void* tag_values_out);
  virtual inline Error getIntArrData(const EntityHandle* entity_handles,
      int entity_handles_size, TagHandle tag_handle, int* tag_values_out);
  virtual inline Error getDblArrData(const EntityHandle* entity_handles,
      int entity_handles_size, TagHandle tag_handle, double* tag_values_out);
...
inline iGeom::Error iGeom::getEntType(EntityHandle handle, EntityType& type_out)
{
  int err, result;
...
inline iGeom::Error iGeom::getArrAdj(const EntityHandle* entity_handles,
    int entity_handles_size, EntityType type_requested, std::vector<
        EntityHandle>& adj_entities_out, int* offsets_out)
{
  if (adj_entities_out.capacity() == 0)
...
inline iGeom::Error iGeom::getArr2ndAdj(const EntityHandle* entity_handles,
    ...
    std::vector<EntityHandle>& adj_entities_out, int* offsets_out)
{
  if (adj_entities_out.capacity() == 0)
    adj_entities_out.resize(12 * entity_handles_size);
  else
...
inline iGeom::Error iGeom::getEntNrmlXYZ(EntityHandle entity, double x,
    double y, double z, double& i, double& j, double& k)
{
  int err;
...
inline iGeom::Error iGeom::getArrEgEvalXYZ(const EntityHandle* edges,
    int edges_size, StorageOrder order, const double* near_coords,
    int near_coords_size, double* on_coords, double* tangent, double* curvature)
{
...
inline iGeom::Error iGeom::getPntArrClsf(StorageOrder order,
    const double* coords, int coords_size, EntityHandle* entities_out)
{
...
inline iGeom::Error iGeom::getEgFcArrSense(const EntityHandle* edges,
    int edges_size, const EntityHandle* faces, int faces_size, int* senses_out)
{
...
inline iGeom::Error iGeom::getFaceType(EntityHandle face, std::string& type)
{
  char buffer[1024];
...
inline iGeom::Error iGeom::getEnt2ndDrvt(EntityHandle handle, double u,
    ...
    double& dvv_j, double& dvv_k, double& duv_i, double& duv_j, double& duv_k)
{
...
inline iGeom::Error iGeom::getTolerance(int& type_out, double& tolerance_out)
{
  int err;
...
inline iGeom::Error iGeom::getArrUVRange(const EntityHandle* faces,
    int faces_size, StorageOrder order, double* uv_min, double* uv_max)
{
  int err, alloc = faces_size, size = 0;
...
inline iGeom::Error iGeom::getArrURange(const EntityHandle* edges,
    int edges_size, double* u_min, double* u_max)
{
...
inline iGeom::Error iGeom::getArrUtoUV(const EntityHandle* edges,
    int edges_size, const EntityHandle* faces, int faces_size,
    const double* edge_u, int edge_u_size, StorageOrder order, double* face_uv)
{
...
iGeom::Error
iGeom::getNumEntSets( EntitySetHandle set, int num_hops, int& num_sets_out )
{
  int err;
...
iGeom::Error
iGeom::isEntContained( EntitySetHandle set, EntityHandle ent, bool& contained_out )
{
  int err, result;
...
iGeom::Error
iGeom::isChildOf( EntitySetHandle parent, EntitySetHandle child, bool& is_child_out )
{
  int err, result;
...
iGeom::Error
iGeom::getNumChld( EntitySetHandle parent, int num_hops, int& num_child_out )
{
  int err;
...
iGeom::Error
iGeom::getNumPrnt( EntitySetHandle child, int num_hops, int& num_parent_out )
{
  int err;
...
iGeom::Error
iGeom::getTagName( TagHandle tag_handle, std::string& name_out )
{
  int err;
  char buffer[1024];
...
iGeom::Error
iGeom::getTagSizeValues( TagHandle tag_handle, int& size_out )
{
  int err;
...
iGeom::Error
iGeom::getTagSizeBytes( TagHandle tag_handle, int& size_out )
{
  int err;
...
iGeom::Error
iGeom::getTagHandle( const char* name, TagHandle& handle_out )
{
  int err;
...
iGeom::Error
iGeom::getTagType( TagHandle tag_handle, TagValueType& type_out )
{
  int err, result;
